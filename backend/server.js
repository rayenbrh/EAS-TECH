...
server.listen(PORT, () => {
  ...
  console.log(`🔗 Mayan EDMS: ${process.env.MAYAN_API_URL || 'Non configuré'}`);
  console.log(`🤖 Service IA: ${process.env.OPENROUTER_API_URL || 'https://openrouter.ai/api/v1'}`);
